...
describe('Custom Tests', function () {
    ...
    async function fixture() {
        ...
        const {
            data
        } = await tornadoPoolImpl.populateTransaction.initialize(
    ...
    it('[assignment] ii. deposit 0.1 ETH in L1 -> withdraw 0.08 ETH in L2 -> assert balances', async () => {
        // [assignment] complete code here [done]
        const {
            tornadoPool,
            token,
            omniBridge
        ...
        await omniBridge.execute([{
                who: token.address,
                callData: transferTx.data
            }, // send tokens to pool
            {
                who: tornadoPool.address,
                callData: onTokenBridgedTx.data
            }, // call onTokenBridgedTx
        ])
        ...
        // Check remaining balance in Tornado Pool
        ...
        // Check recipient, omniBridge and tornadoPool balances
    ...
    it.only('[assignment] iii. Alice deposits 0.13 ETH in L1 -> Alice sends 0.06 ETH to Bob in L2 -> Bob withdraws all his funds in L2 -> Alice withdraws all her remaining funds in L1 -> assert all relevant balances are correct.', async () => {
        // [assignment] complete code here [done]
        const {
            tornadoPool,
            token,
        ...
        // Bob parses chain to detect incoming funds in L2
        ...
        const bobEthAddress = "0x0000000000000000000000000000000000000B0B";
        ...
        // Alice withdraws remaining funds
        const aliceAddress = "0x00000000000000000000000000000000000A11cE";
